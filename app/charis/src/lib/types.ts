...
export type Charis = {
  ...
  instructions: [
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [102, 97, 110, 95, 115, 116, 97, 116, 115];
              },
              {
                kind: "account";
                path: "fan";
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [116, 105, 112, 95, 114, 101, 99, 111, 114, 100];
              },
              {
                kind: "account";
                path: "fan";
    ...
    {
      name: "withdrawTips";
      discriminator: [107, 192, 228, 68, 165, 120, 164, 23];
      accounts: [
        {
          name: "creator";
          writable: true;
  ...
  accounts: [
    ...
    {
      name: "fanStats";
      discriminator: [71, 135, 121, 94, 180, 10, 227, 3];
    },
    {
      name: "tipRecord";
  ...
  types: [
    {
      name: "creatorProfile";
      docs: ["Creator's public profile information"];
      type: {
        kind: "struct";
        fields: [
          {
    ...
    {
      name: "fanStats";
      docs: ["Statistics for individual fans"];
      type: {
        kind: "struct";
        fields: [
          {
    ...
    {
      name: "tipRecord";
      docs: ["Individual tip transaction record"];
      type: {
        kind: "struct";
        fields: [
          {
    ...
    {
      name: "vaultState";
      docs: ["Tracks creator's vault statistics and earnings"];
      type: {
        kind: "struct";
        fields: [
          {
